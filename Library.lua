...
local FetchIcons, Icons = pcall(function()
    return (loadstring(
        https://raw.githubusercontent.com/b7autiful/gui/refs/heads/main/lucide-support
    ) :: () -> IconModule)()
end)
...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        Library:MakeLine(MainFrame, {
          ...
          if WindowInfo.Glow then
            Library.WindowGlow = Library:AddGlow(MainFrame, {
                Size = WindowInfo.GlowSize,
                Transparency = WindowInfo.GlowTransparency,
    ...
    function Window:SetGlowEnabled(Enabled: boolean)
        if Library.WindowGlow then
            Library.WindowGlow.Visible = Enabled
        end
    end

    function Window:SetGlowColor(Color)
        if Library.WindowGlow then
            Library.WindowGlow.ImageColor3 = Color
            Library.Registry[Library.WindowGlow].ImageColor3 = nil
        end
    end
